...
class AnimatedPopupContainer extends StatefulWidget {
  ...
  @override
  _AnimatedPopupContainerState createState() => _AnimatedPopupContainerState();
}
                ...
                Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      resultscard(
                        imagePath:
                            'Assets/Screenshot 2024-02-28 143709-Photoroom.png-Photoroom.png',
                        title: 'Batterie',
                        text: widget.batteryText,
                      ),
                      SizedBox(
                        height: 8,
                      )
